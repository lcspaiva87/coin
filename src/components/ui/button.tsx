...
export const primaryClassName =
  'bg-primary-500 disabled:bg-secondary-500 text-white py-[0.5rem] px-[1rem] text-sm	 rounded-full hover:bg-primary-400 active:bg-primary-600 transition-colors focus:outline-none focus-visible:ring focus-visible:ring-secondary'
